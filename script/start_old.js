...
addData( "player_specific", "UUID-GOES-HERE",											{ "ignoreReq": 1 } );
...
addData( "req_break", "byg:sythian_stalk_block",										{ "farming": 25 } );
...
addData( "req_craft", "create:mechanical_drill",										{ "crafting": 20, "smithing": 10, "mining": 30 } );
addData( "req_craft", "create:mechanical_saw",											{ "crafting": 20, "smithing": 10, "woodcutting": 30 } );
...
addData( "req_craft", "create:deforester",												{ "crafting": 30, "smithing": 30, "woodcutting": 80 } );
...
addData( "req_craft", "mining_dimension:teleporter",									{ "crafting": 100, "smithing": 100 } );
addData( "req_craft", "storagenetwork:export_kabel",									{ "crafting": 90, "smithing": 90 } );
addData( "req_craft", "storagenetwork:filter_kabel",									{ "crafting": 90, "smithing": 90 } );
addData( "req_craft", "storagenetwork:import_filter_kabel",								{ "crafting": 90, "smithing": 90 } );
addData( "req_craft", "storagenetwork:import_kabel",									{ "crafting": 90, "smithing": 90 } );
addData( "req_craft", "storagenetwork:storage_kabel",									{ "crafting": 90, "smithing": 90 } );
addData( "req_craft", "storagenetwork:kabel",											{ "crafting": 90, "smithing": 90 } );
addData( "req_craft", "storagenetwork:request",											{ "crafting": 90, "smithing": 90 } );
addData( "req_craft", "storagenetwork:master",											{ "crafting": 90, "smithing": 90 } );
addData( "req_craft", "storagenetwork:inventory",										{ "crafting": 90, "smithing": 90 } );
addData( "req_craft", "storagenetwork:collector_remote",								{ "crafting": 90, "smithing": 90 } );
addData( "req_craft", "storagenetwork:inventory_remote",								{ "crafting": 90, "smithing": 90 } );
addData( "req_craft", "storagenetwork:picker_remote",									{ "crafting": 90, "smithing": 90 } );
addData( "req_craft", "storagenetwork:speed_upgrade",									{ "crafting": 90, "smithing": 90 } );
addData( "req_craft", "storagenetwork:crafting_remote",									{ "crafting": 90, "smithing": 90 } );
addData( "req_craft", "storagenetwork:stack_upgrade",									{ "crafting": 90, "smithing": 90 } );
...
addData( "req_craft", "mininggadgets:upgrade_silk",										{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:modificationtable",								{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:mininggadget",										{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_empty",									{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_efficiency_1",								{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_efficiency_2",								{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_efficiency_3",								{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_efficiency_4",								{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_efficiency_5",								{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_range_1",									{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_fortune_1",								{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_three_by_three",							{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_void_junk",								{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_range_3",									{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_fortune_3",								{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_freezing",									{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_magnet",									{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_battery_3",								{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_range_2",									{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_fortune_2",								{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_light_placer",								{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_battery_1",								{ "crafting": 40, "mining": 75 } );
addData( "req_craft", "mininggadgets:upgrade_battery_2",								{ "crafting": 40, "mining": 75 } );
...
addData( "req_place", "byg:aspen_sapling",												{ "farming": 2 } );
addData( "req_place", "byg:baobab_sapling",												{ "farming": 2 } );
addData( "req_place", "byg:blue_enchanted_sapling",										{ "farming": 2 } );
addData( "req_place", "byg:pink_cherry_sapling",										{ "farming": 2 } );
addData( "req_place", "byg:white_cherry_sapling",										{ "farming": 2 } );
addData( "req_place", "byg:cika_sapling",												{ "farming": 2 } );
addData( "req_place", "byg:cypress_sapling",											{ "farming": 2 } );
addData( "req_place", "byg:ebony_sapling",												{ "farming": 2 } );
addData( "req_place", "byg:ether_sapling",												{ "farming": 2 } );
addData( "req_place", "byg:fir_sapling",												{ "farming": 2 } );
addData( "req_place", "byg:green_enchanted_sapling",									{ "farming": 2 } );
addData( "req_place", "byg:holly_sapling",												{ "farming": 2 } );
addData( "req_place", "byg:jacaranda_sapling",											{ "farming": 2 } );
addData( "req_place", "byg:indigo_jacaranda_sapling",									{ "farming": 2 } );
addData( "req_place", "byg:lament_sapling",												{ "farming": 2 } );
addData( "req_place", "byg:mahogany_sapling",											{ "farming": 2 } );
addData( "req_place", "byg:mangrove_sapling",											{ "farming": 2 } );
addData( "req_place", "byg:maple_sapling",												{ "farming": 2 } );
addData( "req_place", "byg:red_maple_sapling",											{ "farming": 2 } );
addData( "req_place", "byg:silver_maple_sapling",										{ "farming": 2 } );
addData( "req_place", "byg:nightshade_sapling",											{ "farming": 2 } );
addData( "req_place", "byg:palm_sapling",												{ "farming": 2 } );
addData( "req_place", "byg:palo_verde_sapling",											{ "farming": 2 } );
addData( "req_place", "byg:pine_sapling",												{ "farming": 2 } );
addData( "req_place", "byg:rainbow_eucalyptus_sapling",									{ "farming": 2 } );
addData( "req_place", "byg:redwood_sapling",											{ "farming": 2 } );
addData( "req_place", "byg:skyris_sapling",												{ "farming": 2 } );
addData( "req_place", "byg:willow_sapling",												{ "farming": 2 } );
addData( "req_place", "byg:witch_hazel_sapling",										{ "farming": 2 } );
addData( "req_place", "byg:zelkova_sapling",											{ "farming": 2 } );
addData( "req_place", "byg:withering_oak_sapling",										{ "farming": 2 } );
addData( "req_place", "byg:araucaria_sapling",											{ "farming": 2 } );
addData( "req_place", "byg:blue_spruce_sapling",										{ "farming": 2 } );
addData( "req_place", "byg:brown_birch_sapling",										{ "farming": 2 } );
addData( "req_place", "byg:brown_oak_sapling",											{ "farming": 2 } );
addData( "req_place", "byg:brown_zelkova_sapling",										{ "farming": 2 } );
addData( "req_place", "byg:joshua_sapling",												{ "farming": 2 } );
addData( "req_place", "byg:orange_birch_sapling",										{ "farming": 2 } );
addData( "req_place", "byg:orange_oak_sapling",											{ "farming": 2 } );
addData( "req_place", "byg:orange_spruce_sapling",										{ "farming": 2 } );
addData( "req_place", "byg:orchard_sapling",											{ "farming": 2 } );
addData( "req_place", "byg:red_birch_sapling",											{ "farming": 2 } );
addData( "req_place", "byg:red_oak_sapling",											{ "farming": 2 } );
addData( "req_place", "byg:red_spruce_sapling",											{ "farming": 2 } );
addData( "req_place", "byg:yellow_birch_sapling",										{ "farming": 2 } );
addData( "req_place", "byg:yellow_spruce_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:apple_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:avocado_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:candlenut_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:cherry_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:chestnut_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:gooseberry_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:lemon_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:nutmeg_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:orange_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:peach_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:pear_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:plum_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:walnut_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:spiderweb_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:hazelnut_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:pawpaw_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:soursop_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:almond_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:apricot_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:banana_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:cashew_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:cinnamon_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:coconut_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:date_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:dragonfruit_sapling",								{ "farming": 2 } );
addData( "req_place", "pamhc2trees:durian_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:fig_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:grapefruit_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:lime_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:mango_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:olive_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:papaya_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:paperbark_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:pecan_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:peppercorn_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:persimmon_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:pistachio_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:pomegranate_sapling",								{ "farming": 2 } );
addData( "req_place", "pamhc2trees:starfruit_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:vanillabean_sapling",								{ "farming": 2 } );
addData( "req_place", "pamhc2trees:breadfruit_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:guava_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:jackfruit_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:lychee_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:passionfruit_sapling",								{ "farming": 2 } );
addData( "req_place", "pamhc2trees:rambutan_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:tamarind_sapling",									{ "farming": 2 } );
addData( "req_place", "pamhc2trees:maple_sapling",										{ "farming": 2 } );
addData( "req_place", "pamhc2trees:pinenut_sapling",									{ "farming": 2 } );
...
addData( "req_use", "quark:flamerang",													{ "mining": 60 } );
addData( "req_use", "quark:pickarang",													{ "mining": 40 } );
addData( "req_use", "mininggadgets:upgrade_silk",										{ "mining": 75 } );
addData( "req_use", "mininggadgets:modificationtable",									{ "mining": 75 } );
addData( "req_use", "mininggadgets:mininggadget",										{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_empty",										{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_efficiency_1",								{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_efficiency_2",								{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_efficiency_3",								{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_efficiency_4",								{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_efficiency_5",								{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_range_1",									{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_fortune_1",									{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_three_by_three",								{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_void_junk",									{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_range_3",									{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_fortune_3",									{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_freezing",									{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_magnet",										{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_battery_3",									{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_range_2",									{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_fortune_2",									{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_light_placer",								{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_battery_1",									{ "mining": 75 } );
addData( "req_use", "mininggadgets:upgrade_battery_2",									{ "mining": 75 } );
...
addData( "req_weapon", "minecraft:iron_axe",											{ "combat": 14 } );
...
addData( "req_weapon", "minecraft:stone_axe",											{ "combat": 4 } );
...
addData( "req_wear", "minecraft:leather_helmet",										{ "endurance": 1 } );
addData( "req_wear", "minecraft:leather_chestplate",									{ "endurance": 1 } );
addData( "req_wear", "minecraft:leather_leggings",										{ "endurance": 1 } );
addData( "req_wear", "minecraft:leather_boots",											{ "endurance": 1 } );
...
addData( "skills", "engineering",														{ "color": 16777215 } );
...
addData( "xp_multiplier_dimension", "all_dimensions",									{ "engineering": 1 } );
...
addData( "xp_value_break", "minecraft:stripped_spruce_log",								{ "woodcutting": 8 } );
addData( "xp_value_break", "minecraft:stripped_birch_log",								{ "woodcutting": 8 } );
addData( "xp_value_break", "minecraft:stripped_jungle_log",								{ "woodcutting": 8 } );
addData( "xp_value_break", "minecraft:stripped_acacia_log",								{ "woodcutting": 8 } );
addData( "xp_value_break", "minecraft:stripped_dark_oak_log",							{ "woodcutting": 8 } );
addData( "xp_value_break", "minecraft:stripped_crimson_stem",							{ "woodcutting": 8 } );
addData( "xp_value_break", "minecraft:stripped_warped_stem",							{ "woodcutting": 8 } );
addData( "xp_value_break", "minecraft:stripped_oak_wood",								{ "woodcutting": 8 } );
addData( "xp_value_break", "minecraft:stripped_spruce_wood",							{ "woodcutting": 8 } );
addData( "xp_value_break", "minecraft:stripped_birch_wood",								{ "woodcutting": 8 } );
addData( "xp_value_break", "minecraft:stripped_jungle_wood",							{ "woodcutting": 8 } );
addData( "xp_value_break", "minecraft:stripped_acacia_wood",							{ "woodcutting": 8 } );
addData( "xp_value_break", "minecraft:stripped_dark_oak_wood",							{ "woodcutting": 8 } );
addData( "xp_value_break", "minecraft:stripped_crimson_hyphae",							{ "woodcutting": 8 } );
addData( "xp_value_break", "minecraft:stripped_warped_hyphae",							{ "woodcutting": 8 } );
